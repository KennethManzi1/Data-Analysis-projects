...
To keep the conversation going as many times as you want, I created a following code using a while loop that allows the AI to ask you for assistance until you stop. 
...
This code can be implemented in Jupyter notebook or 
